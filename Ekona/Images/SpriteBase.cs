...
namespace Ekona.Images
{
    public abstract class SpriteBase
    {
        ...
        public Image Get_Image(ImageBase image, PaletteBase pal, int index, int width, int height,
                               bool grid, bool cell, bool number, bool trans, bool img) => Actions.Get_Image(banks[index], block_size, image, pal, width, height,
                                     grid, cell, number, trans, img);

        public Image Get_Image(ImageBase image, PaletteBase pal, Bank bank, int width, int height,
                       bool grid, bool cell, bool number, bool trans, bool img) => Actions.Get_Image(bank, block_size, image, pal, width, height,
                                     grid, cell, number, trans, img);

        public Image Get_Image(ImageBase image, PaletteBase pal, Bank bank, int width, int height,
               bool grid, bool cell, bool number, bool trans, bool img, int currOAM) => Actions.Get_Image(bank, block_size, image, pal, width, height,
                                     grid, cell, number, trans, img, currOAM);

        public Image Get_Image(ImageBase image, PaletteBase pal, int index, int width, int height,
               bool grid, bool cell, bool number, bool trans, bool img, int currOAM) => Actions.Get_Image(banks[index], block_size, image, pal, width, height,
                                     grid, cell, number, trans, img, currOAM);

        public Image Get_Image(ImageBase image, PaletteBase pal, int index, int width, int height,
               bool grid, bool cell, bool number, bool trans, bool img, int currOAM, int[] draw_index) => Actions.Get_Image(banks[index], block_size, image, pal, width, height,
