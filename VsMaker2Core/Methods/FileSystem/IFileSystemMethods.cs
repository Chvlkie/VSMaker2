...
namespace VsMaker2Core.Methods
{
    public interface IFileSystemMethods
    {
        ...
        (bool Success, string ErrorMessage) SaveMessageText(int index, string messageText, int messageArchive);
        (bool Success, string ErrorMessage) SaveTrainerName(int trainerId, string trainerName, int trainerNamesArchive);
    }
}