...
namespace VsMaker2Core.MessageEncrypt
{
    public static class EncryptText
    {
        private static readonly Dictionary<int, string> ReadTextDictionary = VsMakerDatabase.RomData.TextCharacters.ReadTextDictionary;
        private static readonly Dictionary<int, int> WriteTextDictionary = VsMakerDatabase.RomData.TextCharacters.WriteTextDictionary;
