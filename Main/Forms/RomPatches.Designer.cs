namespace Main.Forms
{
    partial class RomPatches
    {
        ...
        private void InitializeComponent()
        {
            ...
            label5.TabIndex = 8;
            label5.Text = "Expand Prize Money Table";
            // 
            // label6
            // 
            ...
            label7.TabIndex = 13;
            label7.Text = "Move the Eye-Contact table from ARM9 and put into the synthetic overlay. This will allow you to insert new classes and set Eye-Contact Music for all classes. ARM 9 Expansion is required";
            // 
            // label8
            // 
            ...
            label8.TabIndex = 12;
            label8.Text = "Expand Eye-Contact Music Table";
            // 
            // checkBox4
            // 
            ...
            label9.TabIndex = 17;
            label9.Text = "Move the Class Gender table from ARM9 and put into the synthetic overlay. This will allow you to insert new classes and set the Gender for all classes. ARM 9 Expansion is required";
            // 
            // label10
            // 
